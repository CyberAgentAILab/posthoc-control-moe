...
class PairDatasets(Dataset):
    def __init__(self, examples, tokenizer, args):
        ...
        input_ids, attention_masks, segment_ids, label_ids = processSentences(
            tokenizer, examples, args
        )
...
class HardDatasets(Dataset):
    def __init__(self, examples):
        ...
        self.len = len(examples)
        self.input_ids, self.attention_masks, self.segment_ids, self.label_ids = (
            hard_process(examples)
        )
